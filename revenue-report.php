...
async function fetchRevenueReport() {
    ...
    const url = `revenue-report.php?start_date=${encodeURIComponent(startDate)}&end_date=${encodeURIComponent(endDate)}&vehicle_type=${encodeURIComponent(vehicleType)}`;
...
<div class="container">
    ...
    <form method="get" action="revenue-report.php" onsubmit="return validateForm()" class="d-flex flex-wrap align-items-center gap-3 mb-3">
